...
This directory contains example applications demonstrating how to use the `@vechain/getters-core` library in different environments.
...
1. Update the exports in `packages/getters-core/src/index.ts`
