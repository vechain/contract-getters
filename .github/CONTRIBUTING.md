# Contributing to Contract Getters

<!-- Find and replace elements that start with '<!--' and remove this line -->

First of all, thank you for considering to contribute to Contract Getters! Your help is invaluable to improve the project and make it more useful for the community. This document will guide you through the contribution process and make it easier for you to get started.
...
If you find a bug, please create a new issue in the [issue tracker](https://github.com/vechain/contract-getters/issues). When submitting a bug report, please include:
...
If you have an idea for a new feature or improvement, please create a new issue in the [issue tracker](https://github.com/vechain/contract-getters/issues). When suggesting an enhancement, please include:
...
Once again, thank you for your interest in contributing to Contract Getters! Your support and collaboration are crucial to the success and growth of this project. If you have any questions or need additional guidance, please don't hesitate to reach out to the maintainers.
