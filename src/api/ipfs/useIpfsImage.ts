...
export const useIpfsImage = (
    ...
    return useQuery({
        queryKey: getIpfsImageQueryKey(networkType, imageIpfsUri),
        queryFn: () => getIpfsImage(networkType, imageIpfsUri!),
        enabled: !!imageIpfsUri && !!networkType,
        staleTime: Infinity,
    });
};
 ...
 */
export const useIpfsImageList = (
    networkType: NETWORK_TYPE,
    imageIpfsUriList: string[]
) => {
    return useQueries({
